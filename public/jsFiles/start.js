...
function preload() {
  this.load.image(
    "bgBackSprite",
    "./img/assets/background/background_1960x1080.png"
  );
  this.load.image(
    "bgBackTreeSprite",
    "./img/assets/background/trees_bg_1960x1080.png"
  );
  this.load.image(
    "bgMiddleTreeSprite",
    "./img/assets/background/trees_fg_1960x1080.png"
  );
  this.load.image(
    "bgFrontSprite",
    "./img/assets/background/front_1960x1080.png"
  );
  this.load.image("platform", "./img/platform.png");
  this.load.spritesheet("player", "./img/assets/player.png", {
    frameWidth: 80,
    frameHeight: 75,
  });
  ...
  this.load.spritesheet("ground", "./img/ground.png", {
    frameWidth: 400,
    frameHeight: 100,
  });
...
function create() {
  ...
  let healthbar = this.add.sprite(
    healthbarContainer.x,
...
const createAligned = (scene, count, texture, scrollFactor) => {
  ...
  for (let i = 0; i < count; ++i) {
    const m = scene.add
      .image(x, scene.scale.height * 0.5, texture)
